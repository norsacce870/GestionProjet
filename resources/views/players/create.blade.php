                ...
                <form action="{{ route('players.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="nom" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('nom') }}">
                        </div>
                        <div>
                            <label for="prenom" class="block font-medium text-sm text-gray-700">Prénom</label>
                            <input type="text" name="prenom" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('prenom') }}">
                        </div>
                    </div>

                    <div>
                        <label for="poste" class="block font-medium text-sm text-gray-700">Poste</label>
                        <input type="text" name="poste" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('poste') }}">
                    </div>

                    <div>
                        <label for="numero" class="block font-medium text-sm text-gray-700">Numéro</label>
                        <input type="number" name="numero" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('numero') }}">
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="naissance_at" class="block font-medium text-sm text-gray-700">Date de naissance</label>
                            <input type="date" name="naissance_at" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('naissance_at') }}">
                        </div>
                        <div>
                            <label for="fin_contrat_at" class="block font-medium text-sm text-gray-700">Fin de contrat</label>
                            <input type="date" name="fin_contrat_at" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('fin_contrat_at') }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" step="0.01" name="poids" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('poids') }}">
                        </div>
                        <div>
                            <label for="taille" class="block font-medium text-sm text-gray-700">Taille (m)</label>
                            <input type="number" step="0.01" name="taille" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('taille') }}">
                        </div>
                    </div>

                    <div>
                        <label for="club" class="block font-medium text-sm text-gray-700">Club</label>
                        <input type="text" name="club" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('club') }}">
                    </div>

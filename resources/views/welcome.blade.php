...
<section class="bg-cover bg-center text-white py-12 px-6 md:px-20" style="background-image: url('14.png');">
  ...
  <div id="partner-carousel" class="relative w-full max-w-5xl mx-auto mt-8" data-carousel="slide">
  <div class="relative h-28 overflow-hidden rounded-lg">
    <div class="hidden duration-700 ease-in-out" data-carousel-item>
      <div class="flex justify-around items-center gap-6">
        ...
        <img src="CANAL-removebg-preview.png" alt="Puma" class="h-20" />
      </div>
    </div>
    <div class="hidden duration-700 ease-in-out" data-carousel-item>
      <div class="flex justify-around items-center gap-6">
        <img src="GESTOCI-removebg-preview.png" alt="@bidjan.net" class="h-20" />
        <img src="RTI-removebg-preview.png" alt="Canal+" class="h-20" />
        <img src="BNI-removebg-preview.png" alt="FIFA (duplicate)" class="h-20" />
        <img src="FIFA-removebg-preview.png" alt="FIFA (duplicate)" class="h-20" />
      </div>
    </div>
  </div>

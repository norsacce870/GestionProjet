...
@section('content')
        ...
        <div class="max-w-7xl mx-auto" data-carousel="slide">
            <div class="relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-lg">
                ...
                <button type="button"
                    ...
                    data-carousel-prev>
                    <span
                        class="inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/30 group-hover:bg-white/50 transition-all duration-300">
    ...
    <section class="bg-white px-4 md:px-6 py-8 md:py-12">
        <div class="max-w-7xl mx-auto">
            ...
            <h2 class="text-2xl md:text-3xl font-bold border-l-4 border-orange-600 pl-4 mb-6 md:mb-8" data-aos="fade-right">
                Notre Actualité</h2>

            <!-- Grille principale -->
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-6">
                <div class="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 gap-4 md:gap-6">
                    <div class="relative h-64 sm:h-full sm:col-span-2 lg:row-span-1 group overflow-hidden"
                        data-aos="zoom-in" data-aos-delay="100">
                        <div class="relative h-64 sm:h-full sm:col-span-2 lg:row-span-1">
                            <img src="{{ asset('3f2bde62b0a5e7535808a56d8987c0e80ba5e8e7.png') }}" alt="Generation 2015"
                            ...
                            <div class="absolute bottom-0 w-full p-4 text-white">
                                <span
                                    class="border-l-4 border-orange-600 pl-2 text-base md:text-lg font-semibold">Generation
                                    2015</span>
                                <p
                                    class="mt-2 text-sm font-normal max-h-0 group-hover:max-h-40 opacity-0 group-hover:opacity-100 transition-all duration-300 overflow-hidden">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in vestibulum tortor,
                                    vitae venenatis lectus. Praesent gravida dapibus neque sit amet molestie. Morbi blandit
                                    eu dolor a luctus.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="relative h-64 sm:h-full group overflow-hidden" data-aos="zoom-in" data-aos-delay="200">
                        <img src="{{ asset('d74405acd139a311e36ce94a2af09e3b25b2d73c.png') }}" alt="Le Nouveau Drogba"
                            class="w-full h-full object-cover rounded transition-transform duration-300 group-hover:scale-110">
                        <div class="absolute inset-0 bg-black/0 group-hover:bg-black/60 transition-all duration-300"></div>
                        <div class="absolute bottom-0 w-full p-4 text-white">
                            <span class="border-l-4 border-orange-600 pl-2 text-base md:text-lg font-semibold">Le Nouveau
                                Drogba</span>
                            <p
                                class="mt-2 text-sm font-normal max-h-0 group-hover:max-h-40 opacity-0 group-hover:opacity-100 transition-all duration-300 overflow-hidden">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus lacinia odio vitae
                                vestibulum vestibulum. Cras porttitor metus justo, vitae fringilla nibh.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative h-64 sm:h-full group overflow-hidden" data-aos="zoom-in" data-aos-delay="300">
                        <img src="{{ asset('17.png') }}" alt="3 Etoiles"
                            class="w-full h-full object-cover rounded transition-transform duration-300 group-hover:scale-110">
                        <!-- Overlay sombre qui apparaît au survol -->
                        <div class="absolute inset-0 bg-black/0 group-hover:bg-black/60 transition-all duration-300"></div>
                        <!-- Titre et texte -->
                        <div class="absolute bottom-0 w-full p-4 text-white">
                            <span class="border-l-4 border-orange-600 pl-2 text-base md:text-lg font-semibold">3
                                Etoiles</span>
                            <!-- Texte Lorem qui apparaît au survol -->
                            <p
                                class="mt-2 text-sm font-normal max-h-0 group-hover:max-h-40 opacity-0 group-hover:opacity-100 transition-all duration-300 overflow-hidden">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec euismod, nisl eget
                                consectetur tempor, nisl nunc ultrices eros, eu porttitor est nisl nec eros.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative h-64 sm:h-full sm:col-span-2 lg:row-span-1 group overflow-hidden"
                        ...
                        <img src="{{ asset('18.png') }}" alt="La liste des Elephants"
                            class="w-full h-full object-cover rounded transition-transform duration-300 group-hover:scale-110">
                        <!-- Overlay sombre qui apparaît au survol -->
                        <div class="absolute inset-0 bg-black/0 group-hover:bg-black/60 transition-all duration-300"></div>
                        <!-- Titre et texte -->
                        <div class="absolute bottom-0 w-full p-4 text-white">
                            <span class="border-l-4 border-orange-600 pl-2 text-base md:text-lg font-semibold">La liste des
                                Elephants</span>
                            <!-- Texte Lorem qui apparaît au survol -->
                            <p
                                class="mt-2 text-sm font-normal max-h-0 group-hover:max-h-40 opacity-0 group-hover:opacity-100 transition-all duration-300 overflow-hidden">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas non laoreet odio. Fusce
                                lobortis porttitor purus, vel vestibulum libero pharetra vel.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg shadow-lg h-auto lg:h-[900px] mt-6 lg:mt-0"
                    data-aos="fade-left" data-aos-delay="500">
                    <h3 class="text-lg md:text-xl font-semibold border-b-2 border-orange-600 pb-2 mb-4 text-gray-800">
                        Actualités</h3>
                    <ul class="space-y-3 text-gray-700 text-sm md:text-base">
                        <li>
                            <a href="#"
                                class="flex items-center text-inherit hover:text-orange-600 transition-colors duration-200 group">
                                <svg class="w-4 h-4 mr-2 text-orange-500 group-hover:text-orange-600 transition-colors duration-200"
    ...
    <section class="relative w-full h-[400px]">
        ...
        <div class="relative z-20 max-w-7xl mx-auto h-full flex items-center px-6">
            <div class="text-white max-w-xl">
                ...
                <a href="#"
                    class="bg-orange-600 text-white font-semibold px-6 py-2 shadow-md hover:bg-orange-700 transition">
                    Voir Plus
                </a>
            </div>
        </div>
    ...
    <section class="bg-white px-4 md:px-6 py-8 md:py-12">
        <div class="max-w-7xl mx-auto">
            <h2 class="text-2xl md:text-3xl font-bold border-l-4 border-orange-600 pl-4 mb-6 md:mb-8"
                data-aos="fade-right">Notre Effectif</h2>

            <!-- Joueur principal - Responsive -->
            <div class="flex justify-center mb-4 md:mb-8" data-aos="zoom-in">
                <div class="text-center">
                    <img src="{{ asset('19.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[80px] sm:w-[100px] border-2 border-gray-300">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 w-full mb-4 md:mb-6">
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="100">
                    <img src="{{ asset('20.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                    <img src="{{ asset('21.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                </div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="300">
                    <img src="{{ asset('22.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                </div>
                ...
                <div class="text-center relative" data-aos="fade-up" data-aos-delay="400">
                    <img src="{{ asset('23.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                    <!-- Flèche droite responsive -->
                    <div
                        class="absolute top-1/2 -right-2 md:-right-4 transform -translate-y-1/2 text-white bg-orange-600 rounded-full">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 w-full mb-4 md:mb-6">
                <!-- Joueur 5 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="100">
                    <img src="{{ asset('24.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                </div>
                ...
                <!-- Joueur 6 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                    <img src="{{ asset('25.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                </div>
                ...
                <!-- Joueur 7 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="300">
                    <img src="{{ asset('26.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                </div>
                ...
                <div class="text-center relative" data-aos="fade-up" data-aos-delay="400">
                    <img src="{{ asset('27.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                    <!-- Flèche droite responsive -->
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 w-full">
                <!-- Joueur 9 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="100">
                    <img src="{{ asset('28.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                </div>
                ...
                <!-- Joueur 10 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                    <img src="{{ asset('29.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                </div>
                ...
                <!-- Joueur 11 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="300">
                    <img src="{{ asset('30.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                </div>
                ...
                <div class="text-center relative" data-aos="fade-up" data-aos-delay="400">
                    <img src="{{ asset('31.png') }}" alt="YAHIA Fofana"
                        class="mx-auto rounded-md w-[70px] sm:w-[80px] md:w-[100px] border-2 border-gray-300">
                    <p class="mt-1 md:mt-2 font-serif text-sm md:text-lg">YAHIA Fofana</p>
                    <p class="text-red-700 text-xs sm:text-sm">Gardien</p>
                    <!-- Flèche droite responsive -->
    ...
    <section class="bg-white px-4 md:px-6 py-8 md:py-12">
        <div class="max-w-7xl mx-auto">
            <div class="flex justify-center mb-8" data-aos="fade-down">
                <h2 class="text-2xl md:text-3xl font-bold border-l-4 border-orange-600 pl-4 text-center">Contactez Nous
                </h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="flex items-center justify-center" data-aos="fade-right" data-aos-delay="200">
                    <div class="flex items-center justify-center">
                        <img src="{{ asset('rectangle 7.png') }}" alt="Champions CAN 2023"
                ...
                <div class="flex flex-col space-y-6" data-aos="fade-left" data-aos-delay="300">
                    <div class="relative">
                        <input type="text" placeholder="Nom & Prénom"
                            class="w-full px-4 py-3 border border-orange-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 text-gray-600 placeholder-gray-400">
                    </div>
                    ...
                    <div class="relative">
                        <textarea placeholder="Message" rows="5"
                            class="w-full px-4 py-3 border border-orange-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 text-gray-600 placeholder-gray-400 resize-none"></textarea>
                    </div>

                    <div class="flex justify-start">
                        <button type="submit"
                            class="bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-8 rounded-lg transition duration-300 shadow-md">
                            Envoyer
                        </button>
                    </div>
                </div>

                ...
                <li>
                    ...
                    <div id="dropdownNavbar"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                            <li>
                                <x-nav-link :href="route('galerie.index')" :active="request()->routeIs('galerie.index')" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    {{ __('Galerie-Photos') }}
                                </x-nav-link>
                            </li>
                            <li>
                                <x-nav-link :href="route('video.index')" :active="request()->routeIs('video.index')" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    {{ __('Vidéos') }}
                                </x-nav-link>
                            </li>
                        </ul>

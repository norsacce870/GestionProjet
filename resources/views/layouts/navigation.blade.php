<nav x-data="{ open: false, init() { if (localStorage.theme === 'dark') { document.documentElement.classList.add('dark') } } }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden gap-3 sm:flex sm:items-center sm:space-x-6 ms-10" x-data="{ openMedia: false, openUsers: false, openCom: false, openInfo: false, openRelations: false }">
                    ...
                    <div class="relative text-sm font-medium mt-2">
                        <x-nav-link :href="route('players.index')" :active="request()->routeIs('players.index')" class="text-gray-800 dark:text-white">
                            {{ __('Players') }}
                        </x-nav-link>
                    </div>

                    <div class="relative text-sm font-medium mt-2">
                        <x-nav-link :href="route('palmares.index')" :active="request()->routeIs('palmares.index')" class="text-gray-800 dark:text-white">
                            {{ __('Palmarès') }}
                        </x-nav-link>
                    </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150 mt-3.5">
